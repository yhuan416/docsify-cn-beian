...
function buildBeian() {
    ...
    // NISMSP
    if (beianOptions.NISMSP && 
        beianOptions.NISMSP.text.length >= 0 && 
        (beianOptions.NISMSP.code.length !== 0 || beianOptions.NISMSP.url.length !== 0)) 
    {
    ...
    hook.doneEach(function() {
		...
		if (!_beian) {
            ...
            if (!_footer.length) {
                ...
                var footer = '<footer id="beianFooter"></footer>';
